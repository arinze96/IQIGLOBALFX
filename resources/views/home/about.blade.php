...
<head>
    <title>About Us - IQIGLOBALFX Bitcoin Crypto Currency Template</title>
                ...
                <div class="row about-content">
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-6 text-center">
                        <img id="about-us" class="img-responsive img-about-us"
                            src="{{ asset('assets/about1.png') }}" alt="about us">
                    </div>
                    <!-- Image Ends -->
                    <!-- Content Starts -->
                    <div class="col-sm-12 col-md-7 col-lg-6">
                        <div class="feature-about">
                            ...
                            <p>IQIGLOBALFX is a successful online trading and investment platform for brokers
                                interested in Foreign Exchange, Stock Market Trading, and Cryptocurrency Trading. We
                                give our users the potential to generate financial returns on both rising and falling
                                prices across indices, FX, commodities, shares and cryptocurrencies. </p>
                        </div>
                        <div class="feature-about">
                            <h3 class="title-about risk-title"><i class="fa fa-warning"></i> risk warning</h3>
                            <p>Bitcoin is not legal tender and is not backed by any government. Accounts and value
                                balances are not subject to any government backed deposit insurance or any other
                                government protections.</p>
                        </div>
                        {{-- <a class="btn btn-primary btn-services" href="#">Our services</a> --}}
                    </div>
                    <!-- Content Ends -->
            ...
            <div class="container">
                ...
                <div class="row text-center facts-content">
                    <div class="text-center heading-facts">
                        <h2>IQIGLOBALFX<span> numbers</span></h2>
                        <p>leading cryptocurrency exchange and trading platform since day one of Bitcoin distribution</p>
                    </div>
                    ...
                    <div class="col-xs-12 buttons">
                        <a class="btn btn-primary btn-pricing" href="{{ route('investmentplans') }}">See plans</a>
                        <span class="or"> or </span>
                        <a class="btn btn-primary btn-register" href="{{ route('user.register') }}">Register Now</a>
                    </div>
                </div>
                <!-- Fact Badges Ends -->
            </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <p class="action-btn"><a class="btn btn-primary"
                                    href="{{ route('user.register') }}">Register Now</a>
                            </p>
...
<!-- Mirrored from slimhamdi.net/IQIGLOBALFX/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Sep 2022 08:09:53 GMT -->
