...
<!-- Mirrored from slimhamdi.net/IQIGLOBALFX/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Sep 2022 08:09:56 GMT -->

<head>

    <title>Contact Us - IQIGLOBALFX Bitcoin Crypto Currency Template</title>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-8 contact-form">
                        ...
                        <form class="form-contact" method="post"
                            action="https://slimhamdi.net/IQIGLOBALFX/php/process-form.php">
                            <!-- Input Field Starts -->
                            ...
                            <!-- Input Field Starts -->
                            <div class="form-group col-md-6">
                                <input class="form-control" name="text" id="subject" placeholder="SUBJECT"
                                    type="text" required>
                            </div>
                            <!-- Input Field Ends -->
                            <!-- Input Field Starts -->
                            ...
                            <div class="contact-page-info">
                                ...
                                <div class="contact-info-box">
                                    ...
                                    <div class="contact-info-box-content">
                                        ...
                                        <p>support@iqiglobalfx.com<br>admin@iqiglobalfx.com</p>
                                    </div>
                                </div>
                                <!-- Contact Info Box Ends -->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <p class="action-btn"><a class="btn btn-primary"
                                    href="{{ route('user.register') }}">Register Now</a></p>
