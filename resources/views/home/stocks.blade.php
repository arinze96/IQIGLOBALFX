            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-6 contact-form">
                        ...
                        <!-- Contact Form Starts -->
                        <form class="form-contact" method="post" action="https://slimhamdi.net/IQIGLOBALFX/php/process-form.php">
                            <!-- Input Field Starts -->
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							...
							<p class="action-btn"><a class="btn btn-primary" href="{{ route("user.register") }}">Register Now</a></p>
